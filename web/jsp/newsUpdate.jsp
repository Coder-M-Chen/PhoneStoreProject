        ...
        <div class="mother-grid-inner">
            ...
            <div class="inner-block">
                <div class="chart-main-block">
                    ...
                    <div class="container">
                        <form class="contact" action="news_update.action" method="post" id="form" enctype="multipart/form-data">
                            <div class="row clearfix" style="width: 100%">
                                <div class="lbl">
                                    <label for="newsHeader">
                                        新闻标题</label>
                                </div>
                                <div class="ctrl">
                                    <input type="text" id="newsHeader" name="newsHeader" value="<s:property value="#session.newsEntity.newsHeader"/>">
                                </div>
                            </div>
                            <div class="row clearfix" style="width: 100%">
                                <div class="lbl">
                                ...
                                <div class="ctrl">
                                    <input type="text" id="newsBody" name="newsBody" value="<s:property value="#session.newsEntity.newsBody"/>">
                                </div>
                            </div>
                            ...
                            <div class="row clearfix" style="width: 100%">
                                ...
                                <div class="ctrl">
                                    <img src="${pageContext.request.contextPath}/images/<s:property value="#session.newsEntity.newsId"/>.png" style="width: 100%">
                                    <input type="file" id="image" name="myFile" placeholder="新闻图片">
                                </div>
                            </div>

                            <div class="row clearfix" style="width: 100%">
                                <div class="lbl">
                                    <label for="newsEndTime">
                                        截止时间</label>
                                </div>
                                <div class="ctrl">
                                    <input type="date" id="newsEndTime" name="newsEndTime" value="<s:property value="#session.newsEntity.newsEndTime"/>">
                                </div>
                            </div>
