            ...
            <div class="inner-block">
                <div class="chart-main-block">
                    <%--添加内容--%>
                        ...
                        <div class="container">
                            <form class="contact" action="news_add.action" method="post" id="form" enctype="multipart/form-data">
                                <div class="row clearfix" style="width: 100%">
                                    ...
                                    <div class="ctrl">
                                        <input type="text" id="newsHeader" name="newsHeader" placeholder="请输入新闻标题（50字以内）">
                                    </div>
                                </div>
                                <div class="row clearfix" style="width: 100%">
                                    <div class="lbl">
                                    ...
                                    <div class="ctrl">
                                        <input type="text" id="newsBody" name="newsBody" placeholder="请输入新闻内容（500字以内）">
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix" style="width: 100%">
                                    ...
                                    <div class="ctrl">
                                        <input type="datetime-local" id="newsEndTime" name="newsEndTime">
                                    </div>
                                </div>
