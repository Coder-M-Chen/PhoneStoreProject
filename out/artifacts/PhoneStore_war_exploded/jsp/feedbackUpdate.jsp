            ...
            <div class="inner-block">
                <div class="chart-main-block">
                    <%--添加内容--%>
                        ...
                        <div class="container">
                            <form class="contact" action="feedback_update.action" method="post" id="form" enctype="multipart/form-data">
                                ...
                                <s:if test="#session.feedbackEntity.feedbackState=='已受理'.toString()||#session.userEntity.userType=='A'.toString()">

                                    <div class="row clearfix" style="width: 100%">
                                        <div class="lbl">
                                            <label for="feedbackMore">
                                                反馈回复</label>
                                        </div>
                                        <div class="ctrl">
