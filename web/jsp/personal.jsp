            ...
            <div class="inner-block">
                <div class="chart-main-block">
                    <%--添加内容--%>
                        ...
                        <div class="container">
                            <form class="contact" action="user_update.action" method="post" id="form" enctype="multipart/form-data">
                                <div class="row clearfix" style="width: 100%">
                                    ...
                                    <div class="ctrl">
                                        <input type="text" id="userId" name="userId" value="<s:property value="#session.userEntity.userId"/>" readonly>
                                    </div>
                                </div>
                                <div class="row clearfix" style="width: 100%">
                                    <div class="lbl">
                                    ...
                                    <div class="ctrl">
                                        <img id="image" src="${pageContext.request.contextPath}/images/<s:property value="#session.userEntity.userId"/>.png">
                                        <input type="file" id="imageInput" name="myFile" placeholder="用户头像">
                                    </div>
                                </div>
                                <div class="row clearfix" style="width: 100%">
                                    <div class="lbl">
                                    ...
                                    <div class="ctrl">
                                        <input type="text" id="vName" name="vName" value="<s:property value="#session.userEntity.vName"/>">
                                    </div>
                                </div>
                                <div class="row clearfix" style="width: 100%">
                                    <div class="lbl">
                                    ...
                                    <div class="ctrl">
                                        <input type="text" id="email" name="email" value="<s:property value="#session.userEntity.email"/>">
                                    </div>
                                </div>
