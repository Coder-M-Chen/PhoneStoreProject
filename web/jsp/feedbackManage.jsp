...
<head>
    ...
    <meta name="keywords" content="Shoppy Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android
                ...
                <div class="header-left" style="width:650px;">
                    ...
                    <div class="search-box" style="width:300px;border:none">
                        <form action="goods_find.action" method="post">
                            ...
                            <input type="text" placeholder="Search..." required="" name="keyString"
                                   style="height:25px;width:160px;border: 1px solid #ccc;">
                                ...
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                    <div class="profile_img">
                                        <span class="prfil-img">
                                            <img src="${pageContext.request.contextPath}/images/<s:property
value="#session.userEntity.userId"/>.png">
                                        </span>
                                        <div class="user-name">
                ...
                <div class="chart-main-block">
                    <%--添加内容--%>
                        ...
                        <table border="0" width="900px">
                            <tr>
                                <td align="center" style="font-size:24px; color:#666">反馈消息管理</td>
                            </tr>
                            <tr>
                        ...
                        <table cellspacing="0" border="1" class="table1">
                            <thead>
                            <tr>
                                <th width="450">反馈编号</th>
                                <th width="450">用户编号</th>
                                <th width="450">反馈类型</th>
                                <th width="450">反馈内容</th>
                                <th width="450">反馈状态</th>
                                <th width="450">处理人员</th>
                                <th width="450">编辑</th></tr>
                            </thead>
                            <tbody>
                            <s:iterator value="list" var="d">
                                <tr>
                                    <td align="center"><s:property value="#d.feedbackId"/></td>
                                    <td align="center"><s:property value="#d.feedbackOwner"/></td>
                            ...
                            <tr>
                                <td align="right">
                                    ...
                                    <s:if test="currPage != 1">
                                        <a href="${pageContext.request.contextPath}/feedback_findAll.action?currPage=1">[首页]</a>&nbsp;&nbsp;
                                        <a href="${pageContext.request.contextPath}/feedback_findAll.action?currPage=<s:property value="currPage-1"/>">[上一页]</a>&nbsp;&nbsp;
                                    </s:if>
                                    <s:if test="currPage != totalPage">
                                        <a href="${pageContext.request.contextPath}/feedback_findAll.action?currPage=<s:property value="currPage+1"/>">[下一页]</a>&nbsp;&nbsp;
                                        <a href="${pageContext.request.contextPath}/feedback_findAll.action?currPage=<s:property value="totalPage"/>">[尾页]</a>&nbsp;&nbsp;
                                    </s:if>
                                </span>
                                </td>
                            </tr>
