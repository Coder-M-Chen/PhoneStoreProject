                    ...
                    <div class="main-page-chart-layer1">
                        <div class="col-md-6 chart-layer1-left">
                            <div class="glocy-chart">
                                <div class="span-2c">
                                    <h3 class="tlt">销售统计视图</h3>
                                    <canvas id="bar" height="300" width="400" style="width: 400px; height: 300px;"></canvas>
                                    <script>
                                        var barChartData = {
                                            labels : <s:property value="#session.goodsNameArray" escapeHtml="false"/> ,
                                            datasets : [
                                                {
                                                    fillColor : "#FC8213",
                                                    data : <s:property value="#session.goodsCountArray"/>
                                                },
                                                {
                                                    fillColor : "#337AB7",
                                                    data : <s:property value="#session.goodsPriceArray"/>
                                                }
                                            ]
                        ...
                        <div class="col-md-6 chart-layer1-right">
                            <div class="user-marorm">
                                <a href="${pageContext.request.contextPath}/cart_topList.action">销量前十的手机</a>
                                <a href="${pageContext.request.contextPath}/cart_bottomList.action">销量后十的手机</a>
                                <form action="cart_statisticsByDate.action" method="post">
                                    <input type="date" name="startDate" placeholder="开始时间">
                                    <input type="date" name="endDate" placeholder="结束时间">
                                    <select name="orderKey">
                                        <option value="1" selected>销量前十的手机排名</option>
                                        <option value="2">销量后十的手机排名</option>
                                    </select>
