            ...
            <div class="inner-block">
                <div class="chart-main-block">
                    <%--添加内容--%>
                        ...
                        <div class="container">
                            <form class="contact" action="type_update.action" method="post" id="form">
                                <div class="row clearfix" style="width: 100%">
                                    ...
                                    <div class="ctrl">
                                        <input type="text" id="name" name="typeId" data-required="true" data-validation="text"
                                               data-msg="Invalid Name" value="<s:property value="#session.typeEntity.typeId"/>" readonly>
                                    </div>
                                </div>
                                <div class="row clearfix" style="width: 100%">
                                    <div class="lbl">
                                    ...
                                    <div class="ctrl">
                                        <input type="text" id="email" name="typeName" data-required="true" data-validation="email"
                                               data-msg="Invalid E-Mail" placeholder="请输入该类型的名称" value="<s:property value="#session.typeEntity.typeName"/>">
                                    </div>
                                </div>
