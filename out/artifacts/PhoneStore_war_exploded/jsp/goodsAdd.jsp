                ...
                <div class="chart-main-block" style="overflow-y: scroll;height: 700px">
                    <%--添加内容--%>
                        ...
                        <div class="container" style="overflow: auto">
                            <form class="contact" action="goods_add.action" method="post" id="form" enctype="multipart/form-data">
                                ...
                                <div class="row clearfix" style="width: 100%">
                                    ...
                                    <div class="ctrl">
                                        <textarea id="goodsInfo" name="goodsInfo" rows="6" cols="10"></textarea>
                                    </div>
                                </div>
                                <div class="row clearfix" style="width: 100%">
                                    <div class="lbl">
                                ...
                                <div class="row clearfix" style="width: 100%">
                                    ...
                                    <div class="ctrl">
                                        <input type="text" id="goodsPrice" name="goodsPrice" placeholder="9999">
                                    </div>
                                </div>
                                <%--<div class="row clearfix" style="width: 100%">--%>
                                    <%--<div class="lbl">--%>
                                    ...
                                    <%--</div>--%>
                                    <%--<div class="ctrl">--%>
                                        <%--<input type="text" id="goodsDiscount" name="goodsDiscount" placeholder="100">--%>
                                    <%--</div>--%>
                                <%--</div>--%>
                                <div class="row clearfix" style="width: 100%">
                                    <div class="lbl">
                                    ...
                                    <div class="ctrl">
                                        <input type="text" name="goodsAmount" id="goodsAmount" placeholder="9999">
                                    </div>
                                </div>
                                <div class="row clearfix" style="width: 100%">
                                    <div class="lbl">
                                    ...
                                    <div class="ctrl">
                                        <input type="text" name="goodsState" id="goodsState" placeholder="在售/停售">
                                    </div>
                                </div>
                                <div class="row clearfix" style="width: 100%">
                                    <div class="lbl">
                                    ...
                                    <div class="ctrl">
                                        <input type="text" name="upMaster" id="upMaster" value="<s:property value="#session.userEntity.userId"/>" readonly>
                                    </div>
                                </div>
                                <div class="row  clearfix" style="width: 100%">
