            ...
            <div class="inner-block">
                <div class="chart-main-block">
                    <%--添加内容--%>
                        ...
                        <form action="comment_update.action" method="post">
                            <p>评论标号：<s:property value="#session.commentEntity.commentId"/> </p>
                            <p>用户编号：<s:property value="#session.commentEntity.userId"/> </p>
                            <p>用户评分：<s:property value="#session.commentEntity.commentStar"/> </p>
                            <p>商品编号：<s:property value="#session.commentEntity.goodsId"/> </p>
                            <p>评论详情：</p><textarea name="commentInfo"></textarea>
                            <p>评论回复：</p><textarea name="commentMore"></textarea>
