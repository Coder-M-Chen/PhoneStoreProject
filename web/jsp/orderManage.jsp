                ...
                <div class="chart-main-block">
                    <%--添加内容--%>
                        ...
                        <table border="0" width="900px">
                            <tr>
                                <td align="center" style="font-size:24px; color:#666">订单管理</td>
                            </tr>
                            <tr>
                                <td align="right" >
                                    <a href="${pageContext.request.contextPath}/order_findByUserAndNoPay.action?currPage=1">未支付</a>
                                    <a href="${pageContext.request.contextPath}/order_findByUserAndNoSend.action?currPage=1">未发货</a>
                                </td>
                            </tr>
                        </table>
                        <br/>
                        <table cellspacing="0" border="1" class="table1">
                            <thead>
                            <tr><th width="450">订单编号</th>
                                <th width="450">订单状态</th>
                                <th width="450">订单价格</th>
                                <th width="450">交易时间</th>
                                <th  width="450">编辑</th>
                            </tr>
                            </thead>
                            <tbody>
                            <s:iterator value="list" var="d">
                                <tr>
                                    <td align="center"><s:property value="#d.orderID"/></td>
                                    <td align="center"><s:property value="#d.orderState"/></td>
                                    <td align="center"><s:property value="#d.orderPrice"/></td>
                                    <td align="center"><s:property value="#d.tradeTime"/></td>
                                    <td align="center"><a href="${pageContext.request.contextPath}/order_toUpdatePage.action?currOrderId=<s:property value="#d.orderID"/>">查看详情</a></td>
                                </tr>
                            </s:iterator>
                            </tbody>
                        </table>
                            ...
                            <tr>
                                <td align="right">
                                    ...
                                    <s:if test="currPage != 1">
                                        <a href="${pageContext.request.contextPath}/order_findAllByTypeAndPage.action?currPage=1">[首页]</a>&nbsp;&nbsp;
                                        <a href="${pageContext.request.contextPath}/order_findAllByTypeAndPage.action?currPage=<s:property value="currPage-1"/>">[上一页]</a>&nbsp;&nbsp;
                                    </s:if>
                                    <s:if test="currPage != totalPage">
                                        <a href="${pageContext.request.contextPath}/order_findAllByTypeAndPage.action?currPage=<s:property value="currPage+1"/>">[下一页]</a>&nbsp;&nbsp;
                                        <a href="${pageContext.request.contextPath}/order_findAllByTypeAndPage.action?currPage=<s:property value="totalPage"/>">[尾页]</a>&nbsp;&nbsp;
                                    </s:if>
                                </span>
                                </td>
                            </tr>
