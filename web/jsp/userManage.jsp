                ...
                <div class="chart-main-block">
                    <%--添加内容--%>
                        ...
                        <table border="0" width="900px">
                            <tr>
                                <td align="center" style="font-size:24px; color:#666">管理员认证审核管理</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td align="right">
                                    ...
                                    <s:if test="currPage != 1">
                                        <a href="${pageContext.request.contextPath}/user_all2Admin.action?currPage=1">[首页]</a>&nbsp;&nbsp;
                                        <a href="${pageContext.request.contextPath}/user_all2Admin.action?currPage=<s:property value="currPage-1"/>">[上一页]</a>&nbsp;&nbsp;
                                    </s:if>
                                    <s:if test="currPage != totalPage">
                                        <a href="${pageContext.request.contextPath}/user_all2Admin.action?currPage=<s:property value="currPage+1"/>">[下一页]</a>&nbsp;&nbsp;
                                        <a href="${pageContext.request.contextPath}/user_all2Admin.action?currPage=<s:property value="totalPage"/>">[尾页]</a>&nbsp;&nbsp;
                                    </s:if>
                                </span>
                                </td>
                            </tr>
