                ...
                <div class="chart-main-block">
                    <%--添加内容--%>
                        ...
                        <table border="0" width="900px">
                            <tr>
                                <td align="center" style="font-size:24px; color:#666">商品管理</td>
                            </tr>
                            <tr>
                                <td align="right" >
                        ...
                        <table cellspacing="0" border="1" class="table1">
                            <thead>
                            <tr>
                                <th width="450">商品编号</th>
                                <th width="450">商品名称</th>
                                <th width="450">商品类型</th>
                                <th width="450">商品状态</th>
                                <th width="450">上架人员</th>
                                <th width="450">编辑</th>
                            </tr>
                            </thead>
                            <tbody>
                            <s:iterator value="list" var="d">
                                <tr>
                                    <td align="center"><s:property value="#d.goodsId"/></td>
                                    <td align="center"><s:property value="#d.goodsName"/></td>
                                    <td align="center">
                                        <s:iterator value="#session.typeList" var="dd">
                                            <s:if test="#dd.typeId==#d.goodsType">
                                                <s:property value="#dd.typeName"/>
                                            </s:if>
                                        </s:iterator>

                                        <%--<s:property value="#d.goodsType"/>--%>
                                    </td>
                                    <td align="center"><s:property value="#d.goodsState"/></td>
                                    <td align="center"><s:property value="#d.upMaster"/></td>
                                    <td align="center">
                                        <a href="${pageContext.request.contextPath}/goods_toUpdatePage.action?currGoodId=<s:property value="#d.goodsId"/>">
                                            查看详情
                                        </a>
                                    </td>
                                </tr>
                            ...
                            <tr>
                                <td align="right">
                                    ...
                                    <s:if test="currPage != 1">
                                        <a href="${pageContext.request.contextPath}/goods_findAll.action?currPage=1">[首页]</a>&nbsp;&nbsp;
                                        <a href="${pageContext.request.contextPath}/goods_findAll.action?currPage=<s:property value="currPage-1"/>">[上一页]</a>&nbsp;&nbsp;
                                    </s:if>
                                    <s:if test="currPage != totalPage">
                                        <a href="${pageContext.request.contextPath}/goods_findAll.action?currPage=<s:property value="currPage+1"/>">[下一页]</a>&nbsp;&nbsp;
                                        <a href="${pageContext.request.contextPath}/goods_findAll.action?currPage=<s:property value="totalPage"/>">[尾页]</a>&nbsp;&nbsp;
                                    </s:if>
                                </span>
                                </td>
                            </tr>
