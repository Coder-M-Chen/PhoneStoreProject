                ...
                <div class="chart-main-block">
                    <%--添加内容--%>
                        ...
                        <table border="0" width="900px">
                            <tr>
                                <td align="center" style="font-size:24px; color:#666">新闻消息管理</td>
                            </tr>
                            <tr>
                                <td align="right" > <a href="${pageContext.request.contextPath}/news_toPage.action?toJsp=addNews">添加</a></td>
                            </tr>
                        </table>
                        <br/>
                        <table cellspacing="0" border="1" class="table1">
                            <thead>
                            <tr>
                                <th width="450">新闻编号</th>
                                <th width="450">标题</th>
                                <th width="450">截止时间</th>
                                <th width="450">上传时间</th>
                                <th width="450">发起人</th>
                            ...
                            <s:iterator value="list" var="d">
                                <tr>
                                    <td align="center"><s:property value="#d.newsId"/></td>
                                    <td align="center"><s:property value="#d.newsHeader"/></td>
                                    <td align="center"><s:property value="#d.newsEndTime"/></td>
                                    <td align="center"><s:property value="#d.newsUpdateTime"/></td>
                                    <td align="center"><s:property value="#d.newsOwner"/></td>
                                    <td align="center">
                                        <a href="news_toUpdatePage.action?currNewsId=<s:property value="#d.newsId"/>">查看详情</a>
                                    </td>
                                </tr>
                            </s:iterator>
                            </tbody>
